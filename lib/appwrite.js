...
export const updateExpenseByID = async (id, expense, lineItems) => {
  try {
    ...
    console.log("old image is: ", currExpense.image);
    console.log("new image is: ", expense.image);
    ...
    const receiptImageUrl = currExpense.image ? currExpense.image : null;
    // const receiptImageUrl = currExpense.image ? currExpense.image : null;
    ...
    //   console.log("old image id is : ", imageId);
